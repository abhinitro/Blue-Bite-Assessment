...
-   Used ReactStrap bootstrap component library(https://reactstrap.github.io/?path=/story/home-installation--page)
-   Used Context Api to maintain the storage
-   I only try to cover the design for mobile screens so please open developer tools and select mobile screen size
-   My core focus area to show case my react skills may be color combination will not match with figma but I tried to cover 90% of the design and also write a test cases for small components
